    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse d-lg-flex justify-content-center" id="navbarNav">
            <ul class="navbar-nav text-center">
                ...
                @auth()
                    <li class="nav-item ">
                        <a class="nav-link active" aria-current="page" href="{{route('albumcreate.create')}}">Создать альбом</a>
                    </li>
                @endauth
{{--                @auth()--}}
{{--                <li class="nav-item text-center">--}}
{{--                    <a class="nav-link active" aria-current="page" href="{{route('album.index')}}">Создание альбома</a>--}}
{{--                </li>--}}
{{--                @endauth--}}
                 @guest()
                <li class="nav-item ">
